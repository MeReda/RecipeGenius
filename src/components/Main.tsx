...
export default function Main() {
  ...
  return (
    <main>
      <p className="main-paragraph">RecipeGenius transforms your available ingredients into delicious recipes. Just
        enter what you have, and our Ai chef creates easy-to-follow dishes, making cooking simple, creative, and
        waste-free!</p>
